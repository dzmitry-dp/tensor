...
if __name__ == '__main__':
    ...
    frames = FramesData(tensors) # таблицы данных

    print('---')
    print("""
    tensors - список объектов, созданных по файлам .md
    folders - список объектов, созданных по каталогам
    frames - объект для анализа полученных объектов
        .symbols - таблица соответвия набору символов и его объекту
    """)
    print('---')
